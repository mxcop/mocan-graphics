...
export default makeScene2D(function* (view: View2D) {
    ...
    addProbe(view, BLUE, probe_pos, 6, 0.0, 120.0, probe16_opacity);
    
    const probe_split1_opacity = createSignal(0.0);
    addProbe(view, GREEN, probe_pos, 12, 120.0, 280.0, probe_split1_opacity);
    
    const probe_split2_opacity = createSignal(0.0);
    addProbe(view, RED, probe_pos, 24, 280.0, 640.0, probe_split2_opacity);
